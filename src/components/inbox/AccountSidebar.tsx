...
const DEMO_ACCOUNTS = [
  { initials: 'YD', color: '#6B5CE7', name: 'Yann Dine', unread: 0 },
  { initials: 'AB', color: '#f97316', name: 'Alex Brown', unread: 16 },
  { initials: 'CD', color: '#ef4444', name: 'Chris Davis', unread: 24 },
  { initials: 'EF', color: '#22c55e', name: 'Emma Foster', unread: 4 },
]
