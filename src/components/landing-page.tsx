                ...
                <div className="flex items-center justify-between mb-8">
                  <div>
                    ...
                    <p className="text-gray-400 mt-2">
                      AI optimized outreach analytics
                    </p>
                  </div>
            ...
            <div className="relative z-10 grid lg:grid-cols-3 gap-8 p-8">
              ...
              <div className="group rounded-[32px] border border-white/10 bg-gradient-to-br from-blue-500/10 to-transparent p-8 transition-all duration-500 hover:-translate-y-2 hover:border-blue-500/30 hover:shadow-[0_0_40px_rgba(59,130,246,0.15)]">
                ...
                <p className="mt-8 text-gray-400 leading-relaxed">
                  AI optimized campaigns increasing reply rates and generating
                  more qualified meetings automatically.
                </p>
              </div>
              ...
              <div className="group rounded-[32px] border border-white/10 bg-gradient-to-br from-purple-500/10 to-transparent p-8 transition-all duration-500 hover:-translate-y-2 hover:border-purple-500/30 hover:shadow-[0_0_40px_rgba(168,85,247,0.15)]">
                <div className="flex items-center justify-between">
                  ...
                  <div className="px-3 py-1 rounded-full bg-purple-500/10 text-purple-300 text-xs border border-purple-500/20">
                    Personalized
                  </div>
                </div>

                <div className="mt-8 rounded-3xl border border-white/10 bg-white/[0.04] p-5 text-gray-300 leading-relaxed shadow-inner">
                  Hey John, I noticed your recent expansion into SaaS sales and
                  thought our AI outreach system could help automate prospecting
                  while increasing reply rates dramatically.
                </div>
              ...
              <div className="group rounded-[32px] border border-white/10 bg-gradient-to-br from-cyan-500/10 to-transparent p-8 transition-all duration-500 hover:-translate-y-2 hover:border-cyan-500/30 hover:shadow-[0_0_40px_rgba(34,211,238,0.15)]">
                <div className="flex items-center justify-between">
                  ...
                  <div className="px-3 py-1 rounded-full bg-cyan-500/10 text-cyan-300 text-xs border border-cyan-500/20">
                    This Month
                  </div>
                </div>

                <div className="mt-8">
                  <div className="text-7xl font-black bg-gradient-to-r from-blue-400 via-cyan-300 to-purple-400 bg-clip-text text-transparent">
                    1,284
                  </div>

                  <div className="mt-3 text-gray-400 text-lg">
                    Qualified leads generated automatically.
                  </div>
                </div>
                ...
                <div className="mt-3 text-sm text-gray-500">
                  84% growth compared to last month
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto space-y-10">
          <div className="text-center mb-20">
            ...
            <p className="text-gray-400 mt-6 text-lg">
              Built for agencies, founders, and outbound sales teams.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center bg-[#0f172a] border border-white/10 rounded-3xl p-8 hover:border-blue-500/40 hover:-translate-y-2 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300">
            ...
            <div>
              ...
              <p className="text-gray-400 text-lg leading-relaxed">
                Create highly personalized outreach messages using AI trained on
                prospect activity and LinkedIn data.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center bg-[#0f172a] border border-white/10 rounded-3xl hover:border-blue-500/40 hover:-translate-y-2 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300">
            ...
            <div className="order-1 md:order-2 p-8">
              ...
              <p className="text-gray-400 text-lg leading-relaxed">
                Automate connection requests, follow-ups, and outbound campaigns
                safely with smart scheduling.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center bg-[#0f172a] border border-white/10 rounded-3xl p-8 min-h-[420px] hover:border-blue-500/40 hover:-translate-y-2 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-gray-400 text-lg leading-relaxed max-w-xl">
                Send personalized AI-generated voice notes that increase reply
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-24">
            ...
            <p className="text-gray-400 text-xl mt-6 max-w-2xl mx-auto leading-relaxed">
              Scale your AI outreach with plans built for creators, startups,
              and agencies.
            </p>
          </div>
            ...
            {[
              {
                ...
                icon: "⚡",
                description:
                  "Perfect for creators and founders launching outbound campaigns.",
              },

              {
                ...
                icon: "🚀",
                description:
                  "Built for scaling startups and high-performing sales teams.",
              },

              {
                ...
                icon: "🏆",
                description:
                  "Advanced automation and analytics for modern outbound agencies.",
              },
            ].map((plan) => (
              <div
                key={plan.name}
              ...
              >
                {/* Glow */}
                <div
                  className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition duration-500 bg-gradient-to-br ${plan.gradient}`}
                />
                ...
                <div className="mt-10 flex items-end gap-2 relative z-10">
                  <span className="text-7xl font-black bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
                    {plan.price}
                  </span>
                ...
                <div className="space-y-5 relative z-10">
                  {[
                    ...
                    >
                      <div className="w-6 h-6 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center text-xs text-white shadow-lg">
                        ✓
                      </div>
      ...
      <section id="testimonials" className="relative z-10 px-6 lg:px-20 pb-32">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-24">
            ...
            <p className="text-gray-400 text-xl mt-6 max-w-2xl mx-auto leading-relaxed">
              See why founders, agencies, and outbound teams are scaling faster
              with AI-powered outreach automation.
            </p>
          </div>
            ...
            {[
              {
                ...
                review:
                  "This platform completely transformed our outbound workflow. We increased reply rates by 4x in under 3 weeks.",
              },

              {
                ...
                review:
                  "The AI personalization is insanely good. It feels like having an SDR team running 24/7 without the overhead.",
              },

              {
                ...
                review:
                  "Voice notes + LinkedIn automation together are a game changer. Our demos doubled after switching.",
              },
            ].map((item) => (
              <div
                key={item.name}
              ...
              >
                ...
                {/* Quote Icon */}
                <div className="absolute top-6 right-6 text-6xl text-white/5 font-black">
                  ”
                </div>
                ...
                <div className="flex gap-1 mb-6 relative z-10">
                  {Array.from({ length: 5 }).map((_, i) => (
                    <span
                      key={i}
                      className="text-yellow-400 text-xl drop-shadow-[0_0_8px_rgba(250,204,21,0.5)]"
                    >
                      ⭐
                    </span>
                  ))}
                ...
                {/* Review */}
                <p className="text-gray-300 leading-relaxed text-lg relative z-10 min-h-[150px]">
                  “{item.review}”
                </p>
                ...
                <div className="flex items-center gap-4 relative z-10">
                  <div className="relative">
                    <img
                      src={item.image}
                      alt={item.name}
                      className="w-16 h-16 rounded-full object-cover border-2 border-white/10 shadow-xl"
                    />
      ...
      >
        <div className="max-w-6xl mx-auto rounded-[40px] border border-white/10 bg-gradient-to-br from-blue-500/10 to-purple-500/10 p-16 text-center overflow-hidden relative">
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-400 text-xl mt-6 max-w-2xl mx-auto leading-relaxed">
              Join thousands of founders and sales teams using AI to automate
              LinkedIn growth.
            </p>
        ...
        {[
          {
            ...
            address:
              "Plot No 6, 4th A Cross, Outer Ring Rd, Kasturi Nagar, Bengaluru — 560043",
          ...
          },
          {
            ...
            address:
              "Team Space Yard, Axis Proxima, Pune–Mumbai Highway, Pune 411034",
            phone: "+91 88888 57588",
            email: "sales@linkedinconnector.ai",
          ...
          >
            {/* PREMIUM GLOW */}
            <div
              className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-all duration-700 bg-gradient-to-br ${office.glow}`}
            />
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-start justify-between mb-14">
                <div className="flex items-center gap-6">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative w-24 h-24 rounded-[30px] border border-white/10 bg-white/[0.05] backdrop-blur-2xl flex items-center justify-center shadow-[0_25px_80px_rgba(0,0,0,0.45)] overflow-hidden">
                      <img
                        src={office.flag}
                        alt={office.flagAlt}
                        className="w-16 h-auto object-cover rounded-lg shadow-lg"
                      />
                    </div>
                  </div>
                  ...
                  {/* TITLE */}
                  <div>
                    <h3 className="text-5xl md:text-6xl font-black text-white tracking-tight leading-none">
                      {office.city}
                    </h3>
                    <div className="mt-4 flex items-center gap-4">
                      <div className="w-12 h-px bg-cyan-400/70" />
                      <span className="text-cyan-300 tracking-[0.35em] text-xs font-black uppercase">
                        {office.type}
                      </span>
                    </div>
                  </div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-5">
                  <div className="min-w-[72px] h-[72px] rounded-3xl bg-white/[0.04] border border-white/10 flex items-center justify-center text-3xl shadow-inner">
                    📍
                  </div>
                  <div>
                    <div className="text-gray-500 uppercase tracking-[0.35em] text-xs font-black mb-3">
                      Address
                    </div>
          ...
          <div className="grid lg:grid-cols-3 gap-16">
            ...
            <div>
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center font-black text-white text-xl shadow-lg shadow-purple-500/20">
                  LC
                </div>
              ...
              <p className="text-gray-400 leading-relaxed max-w-md">
                Scale your LinkedIn outreach using AI-powered automation,
                personalized messaging, and smart campaign workflows.
              </p>
            </div>

            {/* CENTER */}
            <div>
              <h4 className="text-white font-bold tracking-[0.2em] text-sm mb-8">
                COMPANY DETAILS
              </h4>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <div className="text-xs tracking-[0.2em] text-gray-500 mb-2">
                      LEGAL ENTITY
                    </div>

                    <div className="text-gray-200 leading-relaxed">
                      FUELO TECHNOLOGIES (OPC) PRIVATE LIMITED
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <div className="text-gray-300">
                      CIN: U72900KA2022OPC166090
                    </div>

                    <div className="text-gray-400 mt-1">
                      GSTIN: 29AAFCF2179R1ZT
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-300 leading-relaxed">
                      Plot No 6, 4th A Cross, Outer Ring Rd,
                      <br />
